...
from sap_dox_cli.client import DocumentExtractionClient, HttpException, ExtractionException
...
class TestClient(unittest.TestCase):
    ...
    def test_upload_pdf(self):
        with patch.object(self.client, "_session") as mock:
            ...
            self.assertEqual(called_url[0], "http://extraction-service/document-information-extraction/v1/document/jobs")
    ...
    def test_get_result(self):
        with patch.object(self.client, "_session") as mock:
            ...
            self.assertEqual(called_url[0], "http://extraction-service/document-information-extraction/v1/document/jobs/1234")
    ...
    def test_get_result_failure_state(self):
        with patch.object(self.client, "_session") as mock:
            ...
            self.assertRaises(ExtractionException, self.client.get_result, document_id="1234")

    def test_oauth_call(self):
        with patch.object(self.client, "_session") as mock:
            mock.get.side_effect = [TokenExpiredError(), self._create_response(200, status="READY")]
            _ = self.client.get_result(document_id="1234")
